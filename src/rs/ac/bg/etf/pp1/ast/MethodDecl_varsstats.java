...
public class MethodDecl_varsstats extends MethodDecl {

    private MethodUnique MethodUnique;
    private VarDecl_list VarDecl_list;
    private Statement_list Statement_list;

    public MethodDecl_varsstats (MethodUnique MethodUnique, VarDecl_list VarDecl_list, Statement_list Statement_list) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDecl_varsstats(\n");

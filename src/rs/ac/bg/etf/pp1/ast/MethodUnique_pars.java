...
public class MethodUnique_pars extends MethodUnique {

    private MethodType MethodType;
    private String I2;
    private FormPars FormPars;

    public MethodUnique_pars (MethodType MethodType, String I2, FormPars FormPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodUnique_pars(\n");

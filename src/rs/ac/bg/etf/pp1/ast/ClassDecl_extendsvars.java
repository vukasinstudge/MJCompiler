...
public class ClassDecl_extendsvars extends ClassDecl {

    private String I1;
    private Type Type;
    private FieldVarDecl_list FieldVarDecl_list;

    public ClassDecl_extendsvars (String I1, Type Type, FieldVarDecl_list FieldVarDecl_list) {
        this.I1=I1;
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDecl_extendsvars(\n");

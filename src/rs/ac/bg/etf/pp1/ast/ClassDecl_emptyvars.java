...
public class ClassDecl_emptyvars extends ClassDecl {

    private String I1;
    private FieldVarDecl_list FieldVarDecl_list;

    public ClassDecl_emptyvars (String I1, FieldVarDecl_list FieldVarDecl_list) {
        this.I1=I1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDecl_emptyvars(\n");

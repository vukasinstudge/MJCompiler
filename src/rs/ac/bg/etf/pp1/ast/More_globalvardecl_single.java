...
public class More_globalvardecl_single extends More_globalvardecl {

    private Single_globalvardecl Single_globalvardecl;

    public More_globalvardecl_single (Single_globalvardecl Single_globalvardecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("More_globalvardecl_single(\n");

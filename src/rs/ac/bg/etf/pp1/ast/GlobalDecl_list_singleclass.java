...
public class GlobalDecl_list_singleclass extends GlobalDecl_list {

    private ClassDecl ClassDecl;

    public GlobalDecl_list_singleclass (ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalDecl_list_singleclass(\n");

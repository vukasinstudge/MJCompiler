...
public class GlobalDecl_list_singlevar extends GlobalDecl_list {

    private GlobalVarDecl GlobalVarDecl;

    public GlobalDecl_list_singlevar (GlobalVarDecl GlobalVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalDecl_list_singlevar(\n");

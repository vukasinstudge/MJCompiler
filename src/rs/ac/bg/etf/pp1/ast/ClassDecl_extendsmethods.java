...
public class ClassDecl_extendsmethods extends ClassDecl {

    private String I1;
    private Type Type;
    private MethodDecl_list MethodDecl_list;

    public ClassDecl_extendsmethods (String I1, Type Type, MethodDecl_list MethodDecl_list) {
        this.I1=I1;
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDecl_extendsmethods(\n");

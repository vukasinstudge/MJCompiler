...
public class ClassDecl_extendsvarsmethods extends ClassDecl {
    ...
    public ClassDecl_extendsvarsmethods (String I1, Type Type, FieldVarDecl_list FieldVarDecl_list, MethodDecl_list MethodDecl_list) {
        this.I1=I1;
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDecl_extendsvarsmethods(\n");
